...
with open(output_path, 'w', newline='') as txtfile:
    ...
    txtfile.write(f"Total: ${round(total,2)}\n")
    txtfile.write(f"Average Change: ${round(average_change,2)}\n")
    txtfile.write(f"Greatest Increase: {greatest_month} (${greatest_increase})\n")
    txtfile.write(f"Greatest Decrease: {lowest_month} (${greatest_decrease})\n")